...
""",
    ...
    def assertRaisesScriptDestroyed(self, operation):
        self.assertRaisesRegex(ainakan.InvalidOperationError, "script has been destroyed", operation)

    def assertRaisesOperationCancelled(self, operation):
        self.assertRaisesRegex(ainakan.OperationCancelledError, "operation was cancelled", operation)
